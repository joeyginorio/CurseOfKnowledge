...
labels = [['Complex_depth2', 'unorderedAnd', 'Simple_depth2', 'Simple_depth3', 'Simple_depth4', 'Simple_depth5'],\
		['non-recursive', 'recursive'], ['independent', 'dependent'], ['uniform_prior', 'simplicity_prior']]
...
def printer(labels, trueHypothesis, inputList, lambda_noise, independenceAssumptionList, optionList, tau, types, uniformList, teachProb):
